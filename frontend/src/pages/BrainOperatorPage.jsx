...
const BRAIN_PROFILE = {
  alpha: {
    ...
    color: "#3B82F6",
    expected_seats: ["strategist", "executor", "auditor", "crypto"],
    test_intent: { action: "BUY", symbol: "SPY", lane: "equity", confidence: 0.55,
                   rationale: "operator wiring test — alpha" },
  },
  camaro: {
    label: "CAMARO",
    sub: "Rotates strategist / executor / auditor. Posts intents through the gate chain.",
    color: "#F59E0B",
    expected_seats: ["strategist", "executor", "auditor", "crypto"],
  ...
  chevelle: {
    label: "CHEVELLE",
    sub: "Governor / opponent seats only. Crypto twin slots available.",
    color: "#3B82F6",
    expected_seats: ["governor", "opponent", "crypto_governor", "crypto_opponent"],
    test_intent: { action: "BUY", symbol: "SPY", lane: "equity", confidence: 0.55,
                   rationale: "operator wiring test — chevelle" },
  },
  redeye: {
    label: "REDEYE",
    sub: "Adversarial voice. Eligible for every equity seat (incl. governor / opponent).",
    color: "#DC2626",
    expected_seats: ["strategist", "executor", "auditor", "governor", "opponent", "crypto"],
