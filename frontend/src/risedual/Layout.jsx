        ...
        {TIERS.map((t) => {
          ...
          return (
            <button
              ...
              className={
                "px-2.5 py-1 text-[11px] font-mono tracking-wide rounded transition-colors " +
                (active
...
function Header() {
  return (
    <header className="sticky top-0 z-30 border-b border-zinc-900 bg-black/80 backdrop-blur supports-[backdrop-filter]:bg-black/60">
...
function LayoutInner() {
  return (
    <div className="min-h-screen bg-black text-zinc-100 antialiased selection:bg-emerald-500/30">
      <Header />
