"""Camino runner — thin shim. Doctrine in `strategy.py`."""
from __future__ import annotations

from typing import Any

from shared.brains._runner_core import run_tick_for_brain
from shared.brains.camino import strategy as camino_strategy


TICK_LOG_COLLECTION = "camino_native_runtime_ticks"
...
async def tick_once(db) -> dict[str, Any]:
    return await run_tick_for_brain(
        db=db,
        brain_id="camino",
        strategy_fn=camino_strategy.evaluate,
