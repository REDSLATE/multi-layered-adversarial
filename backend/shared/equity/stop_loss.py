"""Equity-lane stop-loss lifecycle.

Wraps the lane-neutral `shared.risk.stop_loss_guard` with equity
position bookkeeping. Lane-isolated: never imports crypto modules.
"""
